...
class GageStatus
{
    ...
    public function initColor(){
        if($this->_inBetween($this->premier)){
            ...
            $this->colorText = 'points to reach '.ucfirst(IRole::PREMIER_STR).' level';
