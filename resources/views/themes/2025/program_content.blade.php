<div class="center-block elite-program elite-program-3 program-section">
  <h3 class="text-center text-capitalize">Who is in the {{ config('elite.PROGRAM_SHORT_NAME') }} program and how do you
    earn points:</h3>
  &nbsp;
  ...
  <div class="program_ele_border">
    ...
    <div style="float:left; width:60%">
      <img src="{{ theme_image('nissan/Nissan_ELITE_i_ELITE-White.png') }}" class="img-responsive center-block"
        style="width: 100%">
      <p class="text-center"><br>
        Dealer Principal<br>
        Sales Manager<br>
