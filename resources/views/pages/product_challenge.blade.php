        ...
        <div class="product-challenge">
            ...
            <div class="d-flex justify-content-center">
                <div class="challenge-section">
                    <p class="header-line">NISSAN ELITE Product Challenge & Award Presentation Events ARE BACK IN 2025!</p>
                    ...
                    <p class="text-content">Our 2024 Masters Champion WAVERLEY NISSAN are holding tightly onto the Title and Trophy! We know the competition will be at an all-time high, as each Dealer team attempts to take the title as their own.</p>
                    <p class="sub-header">Who will be your State Champion and who will take National Masters Title in 2025?</p>
                </div>
            </div>
            <div class="d-flex justify-content-center">
                <div class="program-section">
            ...
            <div class="d-flex justify-content-center">
                <div class="challenge-section">
                    ...
                    <a class="edm-link" target="_blank" href="">Click to REGISTER YOUR PRODUCT CHALLENGE TABLE FOR FY24
                    </a>
                    </br>
                    <span style="color:#c0133c">(1 Table per Dealer with Maximum seating 12)</br>
                    (ELITE Members first preference)</span>
                    </br>
                    <a class="edm-link" target="_blank" href="">Click to VIEW PRODUCT CHALLENGE PHOTOS 
                    </a>
                </div>
            </div>
