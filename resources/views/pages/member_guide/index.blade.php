...
@section('content')
    <div class="d-flex justify-content-center">
        <div class="elite-page dashboard col-11">
            ...
            <div class="d-flex">
                <div class="col-9 page-section-wrap">
                    <img src="{{ theme_image('member_guide/cover.jpg') }}" style="object-fit: fill; width:100%" />
                ...
                <div class="page-widget col-3">
                    ...
                    <a href="{{ route('member_guide.pdf', ['type' => 'region-staff']) }}" target="_blank">
                        <button type="button" class="btn elite-button elite-button-active btn-lg btn-block">Navigating the Site</button>
                    </a>
                    @else
                    <a href="{{ route('member_guide.pdf', ['type' => 'member']) }}" target="_blank">
                        <button type="button" class="btn elite-button elite-button-active btn-lg btn-block">Navigating the Site</button>
                    </a>
                    @endif
                </div>
