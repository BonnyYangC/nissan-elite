...
<script type="text/javascript">
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable(<?php echo $metricData['chart_data']; ?>);
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById(<?php echo json_encode($metricData->chart_name);?>));
