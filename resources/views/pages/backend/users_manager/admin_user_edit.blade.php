    ...
    <div class="container mt-5">
        <div class="content mt-20">
            <div class="columns">
                ...
                <div class="column">
                    <a href="{{ route('admin.admin_users') }}" class="button is-pulled-right is-primary">Go Back</a>
                </div>
            </div>
        </div>
        <div class="content">
            <div class="card  mt-20">
                <div class="card-content">
                    <div class="content">
                        <form action="{{ route('admin.admin_user.edit') }}" method="post" class="form" enctype="multipart/form-data">
                            @csrf
