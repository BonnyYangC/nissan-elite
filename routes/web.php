...
Route::group(['prefix' => 'api'],function (){
    ...
    Route::get('/mock/user/{user}', [App\Http\Controllers\UsersController::class, 'mock'])->middleware('auth')->name('api.user.mock');
    Route::get('/dashboard', [App\Http\Controllers\DashboardController::class, 'dashboard'])->middleware('auth')->name('api.dashboard');
    Route::get('/metrics', [App\Http\Controllers\MetricsController::class, 'metrics'])->middleware('auth')->name('api.metrics');
